...
function LandingPage() {
  const features = [
    { icon: <Camera size={24} />, title: 'AI 体态分析', desc: '拍照即可获得 8 维度专业体态评估，识别头前伸、圆肩、骨盆前倾等问题', color: 'from-primary-500 to-primary-600' },
    { icon: <Dumbbell size={24} />, title: '智能训练方案', desc: '根据体态分析结果，AI 生成渐进式超负荷训练计划', color: 'from-emerald-500 to-emerald-600' },
    { icon: <Apple size={24} />, title: '饮食识别', desc: '拍照识别食物，自动计算热量和营养成分，科学管理饮食', color: 'from-teal-500 to-teal-600' },
    { icon: <Bot size={24} />, title: 'AI 教练对话', desc: '随时咨询健身、营养、体态问题，获得流式响应的专业建议', color: 'from-cyan-500 to-cyan-600' },
  ];
  ...
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-600 via-primary-500 to-emerald-500 text-white">
        ...
        <div className="max-w-5xl mx-auto px-5 pt-20 pb-24 text-center relative">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            拍一张照<br />
            <span className="bg-gradient-to-r from-white to-primary-100 bg-clip-text text-transparent">Know Your Body</span>
          </h1>
          <p className="text-lg md-xl text-primary-100 mb-10 max-w-2xl mx-auto">
            AI 驱动的体态评估与康复矫正专家，8 维度分析、智能训练方案、饮食管理，一站式解决
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/login"
              className="px-8 py-4 bg-white text-primary-700 font-bold rounded-2xl text-lg hover:bg-primary-50 active:scale-[0.98] transition-all shadow-lg"
            >
              免费开始
            </Link>
            <Link
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {stats.map(s => (
              <div key={s.label} className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-primary-700 mb-1">{s.value}</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={s.step} className="text-center">
                ...
                <div className="text-sm font-bold text-primary-500 mb-2">STEP {s.step}</div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <div key={i} className="bg-white rounded-2xl p-6 border border-primary-100">
                <p className="text-primary-600 text-sm leading-relaxed mb-4">&ldquo;{t.text}&rdquo;</p>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-primary-50 rounded-full flex items-center justify-center text-sm font-bold text-primary-600">
                    {t.initial}
                  </div>
                  <div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl border border-primary-200 p-6">
              <h3 className="text-lg font-bold text-primary-800 mb-1">免费版</h3>
              <div className="text-3xl font-bold text-primary-500 mb-4">¥0</div>
              <ul className="space-y-2 mb-6 text-sm text-primary-600">
                <li className="flex items-center gap-2"><Check size={14} className="text-primary-400" /> 每日 2 次体态分析</li>
                <li className="flex items-center gap-2"><Check size={14} className="text-primary-400" /> 每日 1 次训练方案</li>
                <li className="flex items-center gap-2"><Check size={14} className="text-primary-400" /> 每日 2 次饮食识别</li>
                <li className="flex items-center gap-2"><Check size={14} className="text-primary-400" /> 每日 5 次 AI 对话</li>
              </ul>
              <Link href="/login" className="block text-center py-3 bg-primary-50 text-primary-700 rounded-xl font-medium hover:bg-primary-100 transition-colors">
                免费注册
              </Link>
            </div>
            <div className="rounded-2xl border-2 border-primary-500 p-6 relative">
              <div className="absolute -top-3 right-4 bg-primary-500 text-white text-xs font-bold px-3 py-1 rounded-full">推荐</div>
              <h3 className="text-lg font-bold text-primary-800 mb-1">Pro 年度</h3>
              <div className="text-3xl font-bold text-primary-700 mb-1">¥168<span className="text-base font-normal text-primary-400">/年</span></div>
              <div className="text-xs text-primary-300 mb-4">折合 ¥14/月，省 53%</div>
              <ul className="space-y-2 mb-6 text-sm text-primary-600">
                <li className="flex items-center gap-2"><Check size={14} className="text-primary-600" /> 每日 25 次体态分析</li>
                <li className="flex items-center gap-2"><Check size={14} className="text-primary-600" /> 每日 10 次训练方案</li>
                <li className="flex items-center gap-2"><Check size={14} className="text-primary-600" /> 每日 25 次饮食识别</li>
                <li className="flex items-center gap-2"><Check size={14} className="text-primary-600" /> 每日 100 次 AI 对话</li>
              </ul>
              <Link href="/login" className="block text-center py-3 bg-primary-500 text-white rounded-xl font-medium hover:bg-primary-600 transition-colors">
                升级 Pro
              </Link>
            </div>
          </div>
      ...
      <section className="py-20 bg-primary-600 text-white text-center">
        <div className="max-w-2xl mx-auto px-5">
          ...
          <p className="text-primary-100 mb-8">一分钟注册，开启你的体态改善之旅</p>
          <Link
            href="/login"
            className="inline-flex items-center gap-2 px-10 py-4 bg-white text-primary-700 font-bold rounded-2xl text-lg hover:bg-primary-50 active:scale-[0.98] transition-all"
          >
            立即免费开始
            <ArrowRight size={20} />
          </Link>
      ...
      {/* 底部 */}
      <footer className="bg-primary-900 border-t border-primary-800 text-primary-300 py-10">
        <div className="max-w-5xl mx-auto px-5 text-center">
          ...
          <div className="mt-6 text-xs text-primary-400">&copy; 2026 KB教练. All rights reserved.</div>
        </div>
      </footer>
    </div>
  );
    ...
    return (
      <main className="min-h-screen bg-primary-50 flex items-center justify-center">
        <div className="text-center">
          <p className="text-primary-600 mb-2">数据加载失败</p>
          <button
      ...
      <header className="pt-12 pb-8 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-primary-800">{greeting}</h1>
              <p className="text-primary-400">欢迎使用 KB教练</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <Link key={item.href} href={item.href} className="block">
                <div className="bg-white rounded-xl p-4 text-center hover:shadow-sm border border-primary-100 transition-all">
                  <div className="text-primary-600 flex justify-center mb-2">{item.icon}</div>
                  <div className="text-sm text-primary-600">{item.label}</div>
                </div>
              </Link>
            ))}
          </div>
